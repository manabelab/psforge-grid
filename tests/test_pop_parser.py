...
class TestPopParserIntegration:
    ...
    def test_pv_buses(self, west10_system: System) -> None:
        ...
        assert len(pv) == 9
        pv_ids = {b.bus_id for b in pv}
        assert pv_ids == {21, 22, 23, 24, 25, 26, 27, 28, 29}
    ...
    def test_bus_voltage_setpoints(self, west10_system: System) -> None:
        ...
        bus_map = {b.bus_id: b for b in west10_system.buses}
        # Generator bus
    ...
    def test_transmission_line_impedance(self, west10_system: System) -> None:
        ...
        # Find a line between bus 1 and bus 2
        lines_1_2 = [b for b in west10_system.branches if b.from_bus == 1 and b.to_bus == 2]
    ...
    def test_transformer_impedance(self, west10_system: System) -> None:
        ...
        g1_tr = next(b for b in west10_system.branches if b.from_bus == 21 and b.to_bus == 1)
    ...
    def test_load_values(self, west10_system: System) -> None:
        ...
        # Bus 1: largest load on intermediate bus
        assert load_map[1].p_load == pytest.approx(12.0)
        # Bus 9: largest load overall
        assert load_map[9].p_load == pytest.approx(28.3)
